...
class AutismTypeForm(forms.Form):
...
class AutismGuardianQuiz(forms.Form):

    resource = 'ppm-asd-consent-guardian-quiz'

    def __init__(self, *args, **kwargs):
        super(AutismGuardianQuiz, self).__init__(*args, **kwargs)

        # Get fields
        self.fields = _quiz_fields(self.resource)


class AutismIndividualQuiz(forms.Form):

    resource = 'ppm-asd-consent-individual-quiz'

    def __init__(self, *args, **kwargs):
        super(AutismIndividualQuiz, self).__init__(*args, **kwargs)

        # Get fields
        self.fields = _quiz_fields(self.resource)


class AutismIndividualSignatureForm(forms.Form):
...
class AutismGuardianSignatureForm(forms.Form):
...
class AutismWardSignatureForm(forms.Form):
